 ...
 *
 * The SUN_LEN limit is real: `sun_path` is 108 bytes on Linux including the trailing NUL, and both the SSH ControlMaster
 ...
 *  - fallback, when the primary would not fit sun_path (for example, a deeply nested data path):
