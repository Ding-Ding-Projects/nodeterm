...
// clicking then only activates the app instead of running our focus logic.
...
// Backstop for notifications retained by the operating system without a close event. Beyond this,
// the oldest retained one is dropped (its click stops working,
