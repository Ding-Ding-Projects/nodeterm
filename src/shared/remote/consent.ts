...
//
// Inviting a peer grants shell access, so the invite and approval UI must say so in plain words. Per the
...
//
// Wording is the Windows desktop invite copy from docs/remote-sessions.md.

const GRANT_TAIL = ' will be able to run commands on this PC. This is equivalent to giving them SSH access.'
