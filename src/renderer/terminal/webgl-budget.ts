...
/** Master switch for GPU terminal rendering. When false, every terminal uses the DOM renderer.
 *  Default on; `setWebglEnabled` reclaims or re-grants live when it flips. */
let enabled = true
