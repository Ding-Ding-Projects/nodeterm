// Renders the nodeterm app icon into build/icon.png and the multi-resolution build/icon.ico used
// by Windows packaging. Both files are regenerated by npm run make-icon before packaging.
//
// Design: a dark rounded terminal window with the nodeterm node-graph mark in purple.
